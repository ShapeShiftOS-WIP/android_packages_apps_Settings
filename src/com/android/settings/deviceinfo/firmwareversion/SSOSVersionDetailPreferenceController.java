...
public class SSOSVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "SSOSVersionDialogCtrl";
    ...
    public SSOSVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
